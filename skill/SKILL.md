...
Read `aiwiki.health.v1` and `aiwiki.repair_plan.v1`; do not turn either result into a Markdown edit, derived-state build, or dashboard. `CORE-0506` owns the persistent Health Report dashboard.
