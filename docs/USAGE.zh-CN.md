...
可选 schema 标记与迁移边界见 [Schema Compatibility 目录](schema/README.zh-CN.md)。CORE-0404 提供仅声明的 [Extension API v0.1](schema/EXTENSION_SCHEMA.zh-CN.md)，不增加 CLI 命令或自动 Skill 匹配，加载由 CORE-0405 负责；CORE-0407 负责后续匹配合同。
